...
CURRENT_HIGHEST_KEY = 312797 #As of 2020-05-11 @ 20:26 (GMT+12)
...
print("There are {} weeb numbers in the first {} digits of Pi".format(len(sources), len(PI)))
